...
#define CACHENAME @"StoryCache"
#define ORDERCOLUMN @"title"
@import CoreData;

@interface StoryRepository()<NSFetchedResultsControllerDelegate>
{
...
{
    NSLog(@"Story: controllerWillChangeContent");
}
...
- (void)controller:(NSFetchedResultsController *)controller
  didChangeSection:(id<NSFetchedResultsSectionInfo>)sectionInfo
     ...
     forChangeType:(NSFetchedResultsChangeType)type
{
    NSLog(@"Story: didchangesection");
}

- (void)controllerDidChangeContent:(NSFetchedResultsController *)controller
{
    NSLog(@"Story: controllerdidChangeContent");
}

- (NSString *)controller:(NSFetchedResultsController *)controller
sectionIndexTitleForSectionName:(NSString *)sectionName
{
    NSLog(@"Story: sectionIndexTitleForSectionName");
    return @"";
}
@end
